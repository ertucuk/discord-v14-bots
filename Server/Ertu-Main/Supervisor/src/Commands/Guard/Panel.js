...
module.exports = {
  ...
  onCommand: async function (client, message, args, ertuembed) {
    ...
    const ayarbutonları = new ActionRowBuilder()
      .addComponents(
        new ButtonBuilder().setCustomId("sunucuayarkoruma").setLabel("Sunucu Ayar Koruması").setEmoji("807699464332640278").setStyle(ButtonStyle.Secondary),
        new ButtonBuilder().setCustomId("rolkoruma").setLabel("Rol Koruması").setEmoji("807699464332640278").setStyle(ButtonStyle.Secondary),
        new ButtonBuilder().setCustomId("kanalkoruma").setLabel("Kanal Koruması").setEmoji("807699464332640278").setStyle(ButtonStyle.Secondary),
        new ButtonBuilder().setCustomId("bankickkoruma").setLabel("Ban/Kick Koruması").setEmoji("807699464332640278").setStyle(ButtonStyle.Secondary),
        new ButtonBuilder().setCustomId("emojistickerskoruma").setLabel("Emoji/Stickers Koruması").setEmoji("807699464332640278").setStyle(ButtonStyle.Secondary),
      )
    const ayarbutonları2 = new ActionRowBuilder()
      .addComponents(
        new ButtonBuilder().setCustomId("chatguard").setLabel("Chat Guard Koruması").setEmoji("807699464332640278").setStyle(ButtonStyle.Secondary),
      )
    const ayaryedekleme = new ActionRowBuilder()
      .addComponents(
        new ButtonBuilder().setCustomId("yetkiac").setLabel("Yetkileri Aç/Kapat").setEmoji("807699464332640278").setStyle(ButtonStyle.Secondary),
        new ButtonBuilder().setCustomId("urlspammer").setLabel("URL Spammer").setEmoji("807699464332640278").setStyle(ButtonStyle.Secondary),
        new ButtonBuilder().setCustomId("kanalyedek").setLabel("Kanalları/Rolleri Yedekle").setEmoji("807699464332640278").setStyle(ButtonStyle.Secondary),
        new ButtonBuilder().setCustomId("weboffline").setLabel("Web/Çevrimdışı Güvenlik").setEmoji("807699464332640278").setStyle(ButtonStyle.Secondary),
        new ButtonBuilder().setCustomId("database").setLabel("Yedekleme Aç/Kapat").setEmoji("807699464332640278").setStyle(ButtonStyle.Secondary),
      )

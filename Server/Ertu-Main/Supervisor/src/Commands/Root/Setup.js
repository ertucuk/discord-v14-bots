    ...
    onCommand: async function (client, message, args) {
      ...
      .addComponents(
        new StringSelectMenuBuilder()
          ...
          .addOptions([
            { label: 'Kayıt Kurulum', description: 'Kayıt rol & kanallarını kurarsınız.', value: 'ErtuRegister' },
            { label: 'Moderasyon Kurulum', description: 'Moderasyon rol & kanallarını kurarsınız.', value: 'ErtuModeration' },
          ]),
      );
      ...
      .addComponents(
        new StringSelectMenuBuilder()
          ...
          .addOptions([
            { label: 'Log Kurulum', description: 'Log kanallarını kurarsınız.', value: 'ErtuLog'},
            { label: 'Emoji Kurulum', description: 'Emojileri kurarsınız.', value: 'ErtuEmoji' },
            { label: 'Menü Rol Kurulum', description: 'Etkinlik Rollerini kurarsınız.', value: 'ErtuMenu' },
            { label: 'Menü Emojiler Kurulum', description: 'Etkinlik Emojilerini kurarsınız.', value: 'ErtuEmoji2' },
            { label: 'Özel Oda Emojiler Kurulum', description: 'Özel Oda Emojilerini kurarsınız.', value: 'ErtuEmoji3' },
            { label: 'Destek Logları Kurulum', description: 'Destek Loglarını kurarsınız. (En Son Yapınız)', value: 'ErtuLog2' },
            { label: 'Emojileri Sil', description: 'Botun Emojileri Silersiniz', value: 'ErtuEmoji4' },
            { label: 'Botları Yeniden Başlat', description: 'Botları yeniden başlatırsınız.', value: 'ErtuRestart' },
          ]),
      );

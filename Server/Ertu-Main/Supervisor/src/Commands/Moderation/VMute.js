    ...
    onCommand: async function (client, message, args) {
        ...
        .addComponents(
            new StringSelectMenuBuilder()
                ...
                .addOptions([
                    { label: 'Kışkırtma, Trol ve Dalgacı Davranış', description: '5 Dakika', value: 'vmute1', emoji: '1127327012701360148'},
                    { label: 'Özel Odalara İzinsiz Giriş ve Trol', description: '1 Saat', value: 'vmute2', emoji: '1127327012701360148'},
                    { label: 'Küfür, Argo, Hakaret ve Rahatsız Edici Davranış', description: '5 Dakika', value: 'vmute3', emoji: '1127327012701360148'},
                    { label: 'Abartı, Küfür ve Taciz Kullanımı', description: '30 Dakika', value: 'vmute4', emoji: '1127327012701360148'},
                    { label: 'Dini, Irki ve Siyasi değerlere Hakaret', description: '2 Hafta', value: 'vmute5', emoji: '1127327012701360148'},
                    { label: 'Sunucu Kötüleme ve Kişisel Hakaret', description: '1 Saat', value: 'vmute6', emoji: '1127327012701360148'},
                    { label: 'Soundpad, Bass gibi Uygulama Kullanmak', description: '30 Dakika', value: 'vmute7', emoji: '1127327012701360148'},
                 ]),
        );

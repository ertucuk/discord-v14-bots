...
client.on("messageCreate", async (message) => {
    ...
    if(size == 100) {
        ...
        const satirBir = new ActionRowBuilder().addComponents(
            new ButtonBuilder().setCustomId("1").setEmoji(`1129677579641704470`).setStyle(ButtonStyle.Secondary),
            new ButtonBuilder().setCustomId("2").setEmoji(`1129677576995078175`).setStyle(ButtonStyle.Secondary),
            new ButtonBuilder().setCustomId("3").setEmoji(`1157365468525498468`).setStyle(ButtonStyle.Secondary),
            new ButtonBuilder().setCustomId("4").setEmoji(`1129677599396872212`).setStyle(ButtonStyle.Secondary),
            new ButtonBuilder().setCustomId("5").setEmoji(`1129677581797576734`).setStyle(ButtonStyle.Secondary),
        )
